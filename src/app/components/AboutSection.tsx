...
const journeySteps = [
  {
    ...
    description: 'Started Bachelor\'s degree in Software Engineering at the National University of Mongolia.',
    year: '2022',
  },
  {
    phase: '02',
    title: 'Web Development',
    description: 'Began building web applications, learning frontend and backend development fundamentals.',
    year: '2022–2023',
  },
  {
    phase: '03',
    title: 'Backend Development',
    description: 'Deepened backend skills — NestJS, Node.js, REST API design, database architecture.',
    year: '2023–2024',
  },
  {
    phase: '04',
  ...
  },
  {
    ...
    description: 'Worked within enterprise software environment — system analysis, API integration, cross-team coordination.',
    year: '2025',
  },
  {
    phase: '08',
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="reveal-item scroll-reveal-hidden">
              <p className="text-base text-foreground/80 leading-relaxed">
                I have a Bachelor&apos;s degree in Software Engineering from the National University of Mongolia
                and practical experience in web and software system development.
              </p>
            </div>
            <div className="reveal-item scroll-reveal-hidden">
              <p className="text-base text-muted-foreground leading-relaxed">
                I have built web applications, mobile applications and REST APIs using technologies
                including Node.js, NestJS, React, Next.js, Python, Java, Flutter, Kotlin and C#.
                I have worked with PostgreSQL, MySQL and MongoDB.
              </p>
            </div>
            <div className="reveal-item scroll-reveal-hidden">
              <p className="text-base text-muted-foreground leading-relaxed">
                  ...
                  >
                    ...
                    <div className="pt-2 flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className="font-mono text-xs text-muted-foreground flex-shrink-0">{step?.year}</span>
                      </div>
