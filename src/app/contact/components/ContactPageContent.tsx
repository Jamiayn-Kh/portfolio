...
export default function ContactPageContent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Backend connection point — replace with your API endpoint or email service
    setSubmitted(true);
  };
            ...
            <div className="lg:col-span-4 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  >
                    <div className="w-9 h-9 rounded-lg border border-border bg-muted/30 flex items-center justify-center flex-shrink-0 group-hover:border-primary/40 transition-colors">
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-muted-foreground group-hover:text-accent transition-colors" aria-hidden="true">
              ...
              <div className="reveal-item scroll-reveal-hidden gradient-border bg-card rounded-xl p-5">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-muted-foreground group-hover:text-accent transition-colors flex-shrink-0" aria-hidden="true">
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-primary flex-shrink-0" aria-hidden="true">
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
                    <div className="w-16 h-16 rounded-full border border-primary/40 bg-primary/10 flex items-center justify-center">
                      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-primary" aria-hidden="true">
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
                    ...
                    <div className="flex items-center justify-between gap-4 pt-2">
                      <p className="mono-label text-muted-foreground">
                        {/* Backend connection point — wire up to your preferred email service */}
