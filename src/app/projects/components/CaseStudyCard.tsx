        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-semibold text-accent hover:text-primary transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded w-fit"
              aria-expanded={expanded}
            >
              <span>{expanded ? 'Show less' : 'Show full case study'}</span>
              <span
              ...
              <div className="flex flex-col gap-6 border-t border-border pt-6">
                {project.myContribution && (
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">{project.myContribution}</p>
                  </div>
                )}
                {project.challenges && (
                  <div>
                    ...
                    <React.Fragment key={node.label}>
                      <div className="arch-node">
                        <div className="flex flex-col items-center">
                          ...
                          {node.sublabel && (
                            <span className="text-muted-foreground text-xs mt-0.5">{node.sublabel}</span>
                          )}
                        </div>
                      </div>
